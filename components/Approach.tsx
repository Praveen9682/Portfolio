    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        <Card
          ...
          description= "Lorem ipsum dolor sit amet consectetur adipisicing elit. Amet mollitia, repellat velit quae aliquam tempora eligendi quibusdam doloremque saepe nam."
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
